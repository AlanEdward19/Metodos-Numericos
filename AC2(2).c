/*
    ...
    A fazeres:
    criar função para definir novos valores para a e b, dentro da função verifica raizes (feito)
    Criar função de calcular novos valores para novas iterações (feito)
    Criar função de mostrar tabela (Feito)
    Conferir erro do while linha 210 (feito)
    Conferir erro do iteracoes sair errado no mostrarTabela e de repetir linhas (feito)
    Consertar 2 criterio de parada(feito)
    Adicionar ponteiros (Não é o Alan que faz!)...(Alan que fez tbm)
*/
